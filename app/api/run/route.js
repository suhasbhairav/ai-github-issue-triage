...
const SYSTEM_PROMPT = `
You are AI GitHub Issue Triage, a focused AI starter template.
...
function offlineResult(prompt) {
  return `
AI GitHub Issue Triage offline demo

User input:
${prompt}

Structured output:
1. Goal: Turn the request into a production-ready developer ai template workflow.
